...
- `launch_phase4_proper.sh`, `launch_phase4_fromscratch.sh`, `launch_phase4_expansion_warm.sh`, `launch_phase4_expansion_fromscratch.sh` - the exact wrappers reproducing the paired 6-game x 2-seed sweep.
...
(One-off `diag_*.py` diagnostics are kept on disk but gitignored; they are
not part of the tracked toolchain.)

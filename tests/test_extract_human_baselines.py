...
the replay JSONL schema ("Each .recording.jsonl is one human play
...
def test_extract_baselines_win_levels_mismatch_across_sessions_raises(
    ...
    """the project lead's "cheap insurance" check: two sessions of the SAME game

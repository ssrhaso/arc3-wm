...
(harness stdout). It extends the earlier single-cell vc33 dry-run forensic
to all 6 pilot cells, covering both
...
def main() -> None:
    ...
    P("")
    P("Read-only extension of the earlier single-cell vc33 dry-run diagnosis")
